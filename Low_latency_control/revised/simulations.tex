...
\begin{axis}[
    ybar,
    enlargelimits=0.15,
    legend style={at={(0.5,0.85),size=\footnotesize},
...
\addplot[blue!40!black,fill=blue!20!white] coordinates {(0.5 ms,9) (1 ms,19) (1.5 ms,36)};
%\addplot[green!40!black,fill=green!20!white] coordinates {(0.5 ms,9) (1 ms,19) (1.5 ms,36)};
\addplot[red!40!black,fill=red!20!white] coordinates {(0.5 ms,12) (1 ms,28) (1.5 ms,55)};
...
\caption{Histogram of achieved PDRs in $m=50$ balancing board systems (top) fixed PDR, (middle) event-triggered, and (bottom) CALLS scheduling with $\tau_{\max} =1$ ms latency threshold. The proposed control aware scheme achieves similar PDRs for all devices, while the control agnostic scheduling results in large variation in packet delivery.}
\label{fig_bbb_psr}
\end{figure}
%%
...
\begin{axis}[
    ybar,
    enlargelimits=0.15,
    legend style={at={(0.4,.85),font=\footnotesize},
      anchor=north,legend columns=-1},
    ylabel={\# devices supported},
...
\addplot[blue!40!black,fill=blue!20!white] coordinates {(0.5 ms,9) (1 ms,27)};
\addplot[green!40!black,fill=green!20!white] coordinates {(0.5 ms,17) (1 ms,50)};
\addplot[red!40!black,fill=red!20!white] coordinates {(0.5 ms,25) (1 ms,60)};
\legend{Fixed PDR, Event-Trigged, CALLS}
\end{axis}
\end{tikzpicture}
\caption{Total number of balancing ball board devices that can be controlled using Fixed-PDR, Event-Triggered, and CALLS scheduling for various latency thresholds.}
\label{fig_bbb_bar}
\end{figure}
%%%%%%
