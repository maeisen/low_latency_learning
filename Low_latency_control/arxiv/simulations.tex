...
%\input{pendulum.tex}
\centering
\includegraphics[height=.2\textheight]{pendulum.PNG}
...
\begin{figure}
\centering
\includegraphics[width=.45\textwidth]{ip_dist2.pdf}
...
\begin{figure}
\centering
\includegraphics[width=.45\textwidth]{bbb_dist.pdf}
...
\begin{figure}
\centering
\includegraphics[width=.45\textwidth]{bbb_psr.pdf}
