...
a 2x gain on number of devices that can be supported. \red{In future research, we aim to investigate how more sophisticated and realistic modeling,  such as non-linear control or actuation over wireless links, may be used in this control-aware framework.}
